...
public class Inventory : MonoBehaviour
{
    ...
    void ChangeMaskDisplayed(int SlotID, string Mask)
    {
        slots[SlotID].GetComponent<SpriteRenderer>().sprite = Resources.Load(Mask, typeof (Sprite)) as Sprite;
    }
